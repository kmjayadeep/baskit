...
export const defaultConfig: Config = {
  ...
  roles: {
    ...
    planner: { model: "openai-codex/gpt-5.6-luna", reasoning: "high" },
    planReviewer: { model: "openai-codex/gpt-5.6-terra", reasoning: "high" },
    implementer: { model: "openai-codex/gpt-5.6-luna", reasoning: "high" },
    codeReviewer: { model: "openai-codex/gpt-5.6-sol", reasoning: "high" },
    documentation: { model: "openai-codex/gpt-5.6-luna", reasoning: "medium" },
    governanceReviewer: { model: "openai-codex/gpt-5.6-terra", reasoning: "high" },
  },
  limits: {
